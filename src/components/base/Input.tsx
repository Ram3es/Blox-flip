...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ variant = InputVariantEnum.BASE, ...inputProps }, ref) => {
    const inputClasses = clsx('relative z-10 outline-none', {
      ...
      'placeholder:text-white group grow w-0 mr-2 bg-transparent bg-none border-none shadow-none appearance-none m-0 w-full':
        variant === InputVariantEnum.OUTLINED,
      'rounded-xl gradient-blue-secondary min-h-[57px] w-full pl-11':
        variant === InputVariantEnum.FORM
    })
