      ...
      >
        <div className='gradient-blue-secondary rounded h-full text-center relative z-20 group-[.is-selected]/item:border-0'>
          ...
          >
            ...
            <div className='w-2 h-2 outline outline-4 rounded-full bg-green-primary outline-green-primary/25 shadow-green-primary-10 mb-2 group-[.is-added]/item:hidden group-[.is-percent]/item:hidden group-[.is-default]/item:hidden'></div>
            <div className='text-gray-primary mb-2.5 grow flex flex-col justify-center group-[.is-added]/item:text-left'>
              <span>{name}</span>
            </div>
            <div className='w-full group-[.is-default]/item:w-fit group-[.is-added]/item:flex group-[.is-added]/item:items-start'>
