...
const UnboxingWithCounter: FC<IUnboxingCounterCardProps> = ({
  name,
  price,
  count,
  increment,
    ...
    <div className='p-1.5 w-full xxxs:w-1/2 xxs:w-1/3 xs:w-1/4 md:w-1/5  lg:w-1/6 shrink-0'>
      <div className='border--mask border--radial-blue overflow-hidden text-sm bg-gradient-radial-80 from-blue-light-secondary/30 to-blue-accent-secondary/0 rounded h-full text-center relative z-20'>
        <div className='flex flex-col items-center justify-between rounded h-full py-4 px-2 relative z-20 border-y border-y-sky-primary/30'>
          <div className=' min-h-[42px] bg-blue-accent-secondary/50 border border-blue-highlight rounded px-2 w-10/12 py-1 leading-4 font-semibold text-gray-primary mb-3 grow flex flex-col justify-center'>
            {name}
          </div>
