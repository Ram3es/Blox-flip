...
const ToggleRows = ({ value, handleChange, rowOptions, isBlocked = false }: ToggleRowsProps) => {
  return (
    <Listbox value={value} onChange={handleChange}>
      ...
      <Listbox.Options>
        <div className="z-40 relative top-full h-0">
          <div className="overflow-auto h-64 3xl:h-max scrollbar-thumb-blue-secondary space-y-1.5 scrollbar-track-blue-darken/40 scrollbar-thin scrollbar-track-rounded-full scrollbar-thumb-rounded-full absolute mt-2 w-full p-2 border border-blue-highlight rounded rounded-tr-none bg-blue-secondary popup--corner-tr">
            {rowOptions.map((row) => (
