  ...
  return (
    ...
    >
      <div className='space-y-6'>
        <div className='flex items-center justify-center flex-col gap-6 border-b-[1px] border-blue-accent-primary pb-8 mb-6 px-28'>
          <div className='flex items-center gap-2'>
            <ChallengeIcon />
            <h3 className='uppercase text-gradient-gold text-3xl font-black'>challenges</h3>
          </div>
        ...
        <div className='flex items-center'>
          <div className='w-1/4'>SS</div>
          <div className='w-3/4 gradient-trivia-info rounded-br-15  rounded-tr-15 py-7'>
            <div className='leading-8 text-22 font-semibold inline-block border-b-[1px] border-blue-accent-primary mx-9 pb-7 mb-6'>
              <h3>
            ...
            <span className='text-green-accent-secondary flex gap-2 items-center justify-center my-auto font-bold text-lg'>
              <CheckMarkRoundedIcon /> You completed and claimed this challenge
            </span>
          </div>
        </div>
        <div className='rounded-15 gradient-trivia-info py-2 px-20 text-center space-y-6'>
