      ...
      >
        <div className='col-span-1 text-center relative'>
          <div className='absolute w-full h-full flex flex-col items-center  p-4 z-[1] '>
            ...
            />
            <img src={Pilot} alt='pilot' loading='lazy' decoding='async' className='mt-10' />
            <h3 className='text-3xl font-extrabold text-white uppercase mt-5'>Welcome to our site</h3>
            <p className='mt-auto text-blue-ocean'>
              By logging in you acknowledge that you are at least 18 years of age, that any items you
              wager are not stolen, and that you agree with our Terms of conditions and our Privacy
              policy
            </p>
          </div>
          <div
            className=' h-full w-full mix-blend-luminosity bg-cover'
        ...
        <div className=' flex flex-col justify-between h-full col-span-2  relative  w-full'>
          <div>
            <div className=' p-5'>
              <div className='flex justify-between items-center border-b border-blue-highlight mb-6 pb-6'>
                <h3 className='text-3xl font-extrabold text-lightblue-secondary uppercase'>
                  Sign in
                </h3>
                <ButtonsToggle
          ...
          <div className='flex w-[600px] gradient-modal-video p-4'>
            <div className='text-lightblue-secondary w-[70%]'>
              <p className='mb-4'>
                In order for *Site* to operate correctly, we need access to your Roblox account.
              </p>
              <p>
                Press the play button to view a vide of how exactly to sign in using either
                credentials or .roblosecurity on our website.
              </p>
            </div>
