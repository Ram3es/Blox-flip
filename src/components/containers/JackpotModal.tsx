...
const JackpotModal = ({ onClose, onSubmit, userAvatar }: { userAvatar: string, onClose: Function, onSubmit: Function }) => {
      ...
      <ModalWrapper
        ...
        >
         <div className=" flex flex-col xs:flex-row justify-between items-center mr-0 xxs:mr-10 mb-5">
          ...
          <div className='flex flex-col xxs:flex-row justify-start xxs:justify-evenly xs:justify-end items-center text-13 text-blue-ocean-secondary w-full gap-3 mr-2 '>
            <div className='px-4 py-2.5 rounded border border-orange-primary-light/50  bg-gradient-radial-80 from-orange-primary-light/20 to-dark/0'>
          ...
          <div className='flex xs:items-end items-center gap-3'>
            <div className='flex flex-col items-start xs:flex-row xs:items-center gap-3 '>
              ...
              <div className='flex items-center gap-3 flex-wrap'>
                <div className='bg-blue-ocean-secondary/25 border border-blue-ocean-secondary/50 rounded-[3px] px-2.5 py-1.5 text-gray-primary'>
