          ...
          <div className="flex flex-wrap -mx-2 mb-5">
            <div className="relative px-2 w-full xs:w-1/2 md:w-[50%] grow shrink-0 mb-4">
              <InputWithLabel
                ...
                value={variant === 'Deposit' ? renderText : cryptoWallet}
              />
              {variant === 'Deposit' && (
            ...
            {variant === 'Deposit' && (
              <>
                ...
                <span className="text-gray-primary text-center grow lg:pr-36">
                  ...
                  other crypto currency. <br />6 confirmations are required before you are credited
                  to your balance.
                </span>
              </>
            )}
            {variant === 'Withdraw' && (
              <div className="flex flex-col items-center">
                ...
                <div className="font-semibold text-center text-gray-primary mx-auto">
                  ...
                  <br className="hidden xs:inline" /> We’re not responsible for any results of user
                  errors.
                </div>
              </div>
            )}
