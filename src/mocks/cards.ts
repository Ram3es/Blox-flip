...
export const unboxCard = [
  { id: '1', color: 'Orange', image: 'horns', name: 'Red Box', price: 1200, sold: true, hot: true },
  { id: '2', color: 'Blue', image: 'helmet', name: 'Red Box', price: 600, sold: false, hot: true },
  { id: '3', color: 'Pink', image: 'horns', name: ' Red Box', price: 2400, sold: true, hot: true },
